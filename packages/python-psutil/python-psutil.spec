...
# The test suite's remaining deselected set still hits /tmp isolation and
# CPU-affinity limits that the hermetic Hummingbird buildroot does not provide
# (the full deselect list is mock-focused). Skip checks entirely here.
%if 0
%check
