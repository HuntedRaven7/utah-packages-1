...
higher priority. The canonical Mock root configuration is generated by
`tools/render_mock_config.py` into `config/hummingbird-mock.cfg`. Measured in
the build itself, that root reports
